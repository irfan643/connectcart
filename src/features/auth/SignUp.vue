<template>
    ...
    <IonToolbar>
      <div class="flex justify-between items-center">
        ...
        <div class="absolute left-1/2 transform -translate-x-1/2 text-lg capitalize font-Manrope font-semibold text-black">
          Sign in
        </div>
      </div>
    </IonToolbar>
        ...
        <IonContent fullscreen class="ion-padding">
            <div class="w-ull h-full flex flex-col justify-center  align-middle">
                <div class=" gap-6 grid ">
                    ...
                    <div
                        ...
                        <IonInput placeholder="Confirm Password" type="password" v-model="confirm"
...
import { IonPage, IonContent, IonInput, IonButton, IonHeader, IonToolbar, IonIcon } from '@ionic/vue'
import { ref } from 'vue'
